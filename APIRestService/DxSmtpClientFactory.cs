...
namespace DevBizRESTService
{
    class DxSmtpClientFactory
    {
    ...
    {
        public string Host { get { return "smtp-mail.outlook.com"; } }
    ...
    {
        public string Host { get { return "smtp.mail.yahoo.com"; } }
        public int Port { get; set; }
        public bool EnforceSsl { get; set; }
        public NetworkCredential Credentials { get; set; }
        public SmtpClient Client { get; set; }
    ...
    {
        public string Host { get { return "smtp.office365.com"; } }
    ...
    {
        public string Host { get { return "smtp.sendgrid.net"; } }
